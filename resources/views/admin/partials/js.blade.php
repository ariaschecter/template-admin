...
<script src="{{ asset('backend/js/app-chat.js') }}"></script>
<script src="{{ asset('backend/js/app-email.js') }}"></script>
<script src="{{ asset('backend/js/app-todo.js') }}"></script>
<script src="{{ asset('backend/js/calander-init.js') }}"></script>
<script src="{{ asset('backend/js/chart-active.js') }}"></script>
<script src="{{ asset('backend/js/chart.umd.js') }}"></script>
<script src="{{ asset('backend/js/cleave.min.js') }}"></script>
<script src="{{ asset('backend/js/countrySelect.js') }}"></script>
<script src="{{ asset('backend/js/dragula.js') }}"></script>
...
<script src="{{ asset('backend/js/map-active.js') }}"></script>
<script src="{{ asset('backend/js/nice-select.min.js') }}"></script>
<script src="{{ asset('backend/js/owl.carousel.min.js') }}"></script>
<script src="{{ asset('backend/js/plyr.min.js') }}"></script>
<script src="{{ asset('backend/js/popper.js') }}"></script>
