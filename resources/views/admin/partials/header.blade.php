        ...
        <div class="flex justify-between items-center h-full">
            <div
                ...
                <a href="index.html" class="mobile-logo xl:hidden inline-block">
                    <img src="{{ asset('backend/images/logo/logo-c.svg') }}" class="black_logo"
                        alt="logo">
            ...
            <div class="items-center space-x-4 rtl:space-x-reverse horizental-box">
                <a href="index.html">
                    <span class="xl:inline-block hidden">
                        <img src="{{ asset('backend/images/logo/logo.svg') }}" class="black_logo"
                            alt="logo">
                        <img src="{{ asset('backend/images/logo/logo-white.svg') }}" class="white_logo"
                            alt="logo">
                    </span>
                    <span class="xl:hidden inline-block">
                        <img src="{{ asset('backend/images/logo/logo-c.svg') }}" class="black_logo"
                            alt="logo">
                        <img src="{{ asset('backend/images/logo/logo-c-white.svg') }}"
                                ...
                                <div
                                    ...
                                    <div class="flex-none">
                                        <div
                                            ...
                                            <img src="{{ asset('backend/images/all-img/user2.png') }}"
                                                alt="user"
                                                class="block w-full h-full object-cover rounded-full border hover:border-white border-transparent">
                                        </div>
                                    </div>
                ...
                <div class="md:block hidden w-full">
                    <button
                        ...
                        <div
                            ...
                            <img src="{{ asset('backend/images/all-img/user.png') }}" alt="user"
